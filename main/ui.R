  ...
  navbarPage(em("EcTracker"),
             ...
             tabPanel("Analysis" , icon = icon("angle-double-right"),
                     ...
                     tabPanel(tags$b("1. Upload") ,
                                 ...
                                 em(h6("Note:" )),em(h6("Takes atleast 15-20 minutes to run", style = "color:#FF0000;")),

                                    actionButton("batch1","Batch Correction"),
                                    withLoader(uiOutput("batch_corrected"),type="image",loader = "black_loader.jpg"),

                                    downloadLink('downloadData_batch', 'Download', class = "butt"),
                                  tags$head(tags$style(".butt{color: #FFFF00;}")),
                                    br(),br(),


                                    fileInput("file","Upload Expression matrix(Maximum Size Limit is 10GB)"),
                                    #,br(),h6("Maximum Size Limit is 10GB"),
                                           ...
                                           withLoader(tableOutput("dat"),type="image",loader = "black_loader.jpg"),
                                           h6("Dimensions"),
                                           withLoader(verbatimTextOutput("dimen"),type="image",loader = "black_loader.jpg"),
...
tabsetPanel(type = "tabs",
            ...
            tabPanel("DropClust (Fatser)",
                    ...
                    h6("Scatter Plot of PCA"),br(),
                     ...
                     withLoader( plotOutput("drop_clust_plot"),type="image",loader = "black_loader.jpg"),
            ...
            tabPanel("Seurat (Slower)",
                                ...
                                br(),br(),
                                h6("Object"),
                             withLoader(verbatimTextOutput("seu_object"),type="image",loader = "black_loader.jpg"),br(),
                                actionButton("EX1","Explanation",icon = icon("book-open")),
                                withLoader(verbatimTextOutput("ex_object"),type="image",loader = "black_loader.jpg"),

                       br(),br(),

                                h6("Variable Feature Plot"),

                               withLoader( plotOutput("p1"),type="image",loader = "black_loader.jpg"),

                                br(), downloadButton(outputId="dndPlot","Download Plot"),
                     actionButton("EX2","Explanation", icon = icon("book-open")),

                     withLoader(verbatimTextOutput("ex_variable"),type="image",loader = "black_loader.jpg"),



                    br(),br(),
                      h6("Variable Features"),
                      withLoader(plotOutput("plot_vf"), type="image", loader = "black_loader.jpg"),
                     br(), downloadButton(outputId="vfPlot","Download Plot"),
                     actionButton("EX4","Explanation",icon = icon("book-open")),

                     withLoader(verbatimTextOutput("ex_vfeature"),type="image",loader = "black_loader.jpg"),
                      ...
                      br(),br(),
                      h6("PCA"),
                      withLoader(plotOutput("pca"),type="image",loader = "black_loader.jpg"),
                      br(),downloadButton(outputId="pcaPlot","Download Plot"),
                      actionButton("EX6","Explanation", icon = icon("book-open")),
                       withLoader(verbatimTextOutput("ex_pca"),type="image",loader = "black_loader.jpg"),


                     br(),br(),

                      h6("Heat Map"),
                      withLoader(plotOutput("heatmap"),type="image",loader = "black_loader.jpg"),
                      br(),

                      downloadButton(outputId="heatmapPlot","Download Plot"), actionButton("EX7","Explanation", icon = icon("book-open")),

                      withLoader(verbatimTextOutput("ex_heatmap"),type="image",loader = "black_loader.jpg"),
                     ...
                     withLoader(plotOutput("jackstraw"),type="image",loader = "black_loader.jpg"),
                      br(),

                     downloadButton(outputId="jackstrawPlot","Download Plot"),actionButton("EX8","Explanation", icon = icon("book-open")),

                     withLoader(verbatimTextOutput("ex_jackstraw"),type="image",loader = "black_loader.jpg"),

                     br(),
                     br(),
                     h6("Elbow Plot"),
                      withLoader(plotOutput("elbow"),type="image",loader = "black_loader.jpg"),
                     br(),
                    downloadButton(outputId="elbowPlot","Download Plot"),actionButton("EX9","Explanation", icon = icon("book-open")),

                    withLoader(verbatimTextOutput("ex_elbow"),type="image",loader = "black_loader.jpg"),
                    br(),br(),



                      h6("UMAP"),
                      withLoader(plotOutput("umap"),type="image",loader = "black_loader.jpg"),
                      br(),
                      downloadButton(outputId="umapPlot","Download Plot"),
                      actionButton("EX10","Explanation", icon = icon("book-open")),

                      withLoader(verbatimTextOutput("ex_umap"),type="image",loader = "black_loader.jpg"),
                    ...
                    tabPanel(tags$b("3. DEG Analysis"),
                             tabsetPanel(type = "tabs",
                                         tabPanel("DropClust",
                                                  ...
                                                  h6("Diffrential Expression Genes"),br(),
                                                  withLoader( uiOutput("drop_clust_markers"),type="image",loader = "black_loader.jpg"),
                                                  downloadLink('drop_clust_de', 'Download', class = "butt"),

br(),br(),

                                                  #("Heat Map of the genes"),br(),
                                                 # withLoader( plotOutput("drop_clust_heatmap"),type="image",loader = "black_loader.jpg"),
                                                  ),

                                         tabPanel("Seurat",  sliderInput("log_fc", "Select Fold Change Threshold (log)",
                                         min = 0, max = 20,step=0.25,
                                         value = 1),
                             selectInput("test_use","Choose the test for DE genes",choice=c("wilcox","Likelihood-ratio test for single cell gene expression","ROC analysis","Student's t-test","negative binomial generalized linear model","poisson generalized linear model","logistic regression ","MAST","DESeq2")),
                             br(),
                               downloadLink('downloadData', 'Download', class = "butt"),
                      br(),br(),
                     h6("Markers Table"),
                    withLoader(tableOutput("markers_display"),type="image",loader = "black_loader.jpg"),
                     useShinyjs(),
                     br(),
                    ...
                    withLoader(verbatimTextOutput("merge_meta"),type="image",loader = "black_loader.jpg"),
                    downloadLink('downloadData_meta', 'Download', class = "butt"),
                     br(),
                   br(),
                   h6("Feature Plot"),
                   textInput("feature_plot","Enter Gene Name"),
                   withLoader(plotOutput("feature_plot_result"),type="image",loader = "black_loader.jpg"),
                   
                   br(), 
                   h6("Genomic Location"),br(),br(),
                   withLoader(plotOutput("de_karyotype"),type="image",loader = "black_loader.jpg"),
                   br(),
                   downloadButton(outputId="karyoplott","Download Plot"),
                   actionButton("EX2","Explanation", icon = icon("book-open")),
                   
                   withLoader(verbatimTextOutput("ex_karyo"),type="image",loader = "black_loader.jpg"),
                   
                   
                    h6("Generate Cluster Table"),
                      withLoader(verbatimTextOutput("cluster_ident"),type="image",loader = "black_loader.jpg"),
                   ...
                   tabPanel(tags$b("4. CellEnrich "),
                            ...
                            tabsetPanel(type = "tabs",
                                        tabPanel(" AUCell (Method I)",
                                                 ...
                                                 br(), h6("Cell Ranking"),
                                                 withLoader(plotOutput("cell_rank"),type="image",loader = "black_loader.jpg"),
                                                 br(), actionButton("ex11","Explanation", icon = icon("book-open")),
                                                 withLoader(verbatimTextOutput("ex_cellrank"),type="image",loader = "black_loader.jpg"),


                                                 br(), br(),   h6(" Cell Assignment"),
                                                 withLoader(plotOutput("au_cell_R"),type="image",loader = "black_loader.jpg"),br(),
                                                 actionButton("ex11","Explanation", icon = icon("book-open")),
                                                 withLoader(verbatimTextOutput("ex_assign"),type="image",loader = "black_loader.jpg"),


                                                 br(), br(),  h6("UMAP"),
                                                 withLoader(plotOutput("tsne"),type="image",loader = "black_loader.jpg"),
                                                 br(),  actionButton("ex11","Explanation", icon = icon("book-open")),
                                                 withLoader(verbatimTextOutput("ex_uma"),type="image",loader = "black_loader.jpg"),

                                              br(),   br(),  h6("Plot for Signatures"),
                                                 withLoader(plotOutput("c_tsne"),type="image",loader = "black_loader.jpg"),
                                                 br(),
                                                  actionButton("ex11","Explanation", icon = icon("book-open")),
                                                 withLoader(verbatimTextOutput("ex_umappp"),type="image",loader = "black_loader.jpg"),
                                        ...
                                        tabPanel(" Stouffer Score (Method II)",
                                                 ...
                                                 h6("Stouffer Plot"),
                                                 withLoader(plotOutput("stouffer_sc_plot"),type="image",loader = "black_loader.jpg"),
                                                 br(), downloadButton(outputId="cell_stoudownload","Download Plot"),

                                                 actionButton("ex12","Explanation", icon = icon("book-open")),
                                                 withLoader(verbatimTextOutput("ex_stouffer"),type="image",loader = "black_loader.jpg"),

                                                 br(),   br(),h6("One Sided Wilcoxon P-Value"),
                                                 withLoader(uiOutput("Stouffer_sc"),type="image",loader = "black_loader.jpg"), br(),
                   ...
                   tabPanel( tags$b("5. TissueEnrich"),
                             tabsetPanel(type = "tabs",
                                         ...
                                         tabPanel("Hypergeometric method (Method I)",
                                                  ...
                                                  withLoader(verbatimTextOutput("tissue_detail"),type="image",loader = "black_loader.jpg"),
                                                 ...
                                                 h6("Fold Change Plot"),
                                                  ...
                                                  withLoader(plotOutput("plot_fold"),type="image",loader = "black_loader.jpg"),
                                                  br(),
                                                  ...
                                                  withLoader(plotOutput("plot_log"),type="image",loader = "black_loader.jpg"),
                                         ...
                                         tabPanel("Stouffer Score (Method II)",
                                                  ...
                                                  tabsetPanel( type= "tabs",
                                                               ...
                                                               tabPanel("HPA Data",
                                                                        ...
                                                                        h6("Stouffer Score "),
                                                                        withLoader(plotOutput("hpa_stouffer"),type="image",loader = "black_loader.jpg"),
                                                                        br(),
                                                                      downloadButton(outputId="hpaplot","Download Plot"),
                                                                      actionButton("ex12","Explanation", icon = icon("book-open")),
                                                                      withLoader(verbatimTextOutput("ex_stouffer_hpa"),type="image",loader = "black_loader.jpg"),


                                                                      br(),br(),
                                                                        h6("One Sided Wilcoxon P-Value"),
                                                                        withLoader(uiOutput("hpa_set2"),type="image",loader = "black_loader.jpg"),
                                                               ...
                                                               br(), tabPanel("GTEx Data",br(),br(),
                                                                              ...
                                                                              withLoader(plotOutput("gtex_stouffer"),type="image",loader = "black_loader.jpg"),
                                                                              br(),
                                                                              downloadButton(outputId="gtexplot","Download Plot"),
                                                                              actionButton("ex12","Explanation", icon = icon("book-open")),
                                                                              withLoader(verbatimTextOutput("ex_stouffer_gtex"),type="image",loader = "black_loader.jpg"),

                                                                              br(),br(),

                                                                              h6("One Sided Wilcoxon P-Value"),
                                                                              withLoader(uiOutput("gtex_pstouffer"),type="image",loader = "black_loader.jpg"),
                   ...
                   tabPanel(tags$b("6. Gene Regulatory Network"),
                            tabsetPanel(
                              tabPanel("Cell Cluster",
                                       ...
                                       withLoader(verbatimTextOutput("grn_clust"),type="image",loader = "black_loader.jpg"),
                              ...
                              tabPanel("CellEnrich",
                                      ...
                                      withLoader(simpleNetworkOutput("cell_grn_1"),type="image",loader = "black_loader.jpg"),
                                      h6("Gene Regulatory Network for CellEnrich (Interaction between Target Genes and Tissue Signatures)"),
                                      withLoader(simpleNetworkOutput("cell_grn"),type="image",loader = "black_loader.jpg"),


                                       actionButton("ex_grn","Explanation", icon = icon("book-open")),
                                       withLoader(verbatimTextOutput("ex_cellgrn"),type="image",loader = "black_loader.jpg"),


                                       br(),br(),
                                       h6("Gene Regulatory Table"),
                                       withLoader(uiOutput("cell_grn_table"),type="image",loader = "black_loader.jpg"),br(),
                                       actionButton("ex_cellgrn","Explanation", icon = icon("book-open")),
                                      downloadLink('download_cell_gt', 'Download Table', class = "butt"),br(),br(),

                                       withLoader(verbatimTextOutput("ex_cellgrn_table"),type="image",loader = "black_loader.jpg"),
                                       br(), actionButton("toTop6", "Top", icon = icon("arrow-alt-circle-up")),
                                         ...
                                         withLoader(simpleNetworkOutput("hpa_grn"),type="image",loader = "black_loader.jpg"),
                                         h6("Gene Regulatory Network for HPA Datasets (Interaction between Target Genes and Tissue Signatures)"),
                                         withLoader(simpleNetworkOutput("hpa_grn_1"),type="image",loader = "black_loader.jpg"),

                                         br(),

                                         actionButton("ex_grn","Explanation", icon = icon("book-open")),
                                         withLoader(verbatimTextOutput("ex_hpagrn"),type="image",loader = "black_loader.jpg"),

                                         h6("Gene Regulatory Table (HPA)"),
                                         withLoader(uiOutput("hpa_grn_table"),type="image",loader = "black_loader.jpg"),
                                         br(),
                                         downloadLink('download_hpa_gt', 'Download Table', class = "butt"),br(),br(),
                                         actionButton("ex_grn","Explanation", icon = icon("book-open")),
                                         withLoader(verbatimTextOutput("ex_hpagrn_table"),type="image",loader = "black_loader.jpg"),br(),br(),

                                         h6("Gene Regulatory Network for GTEx data (Interaction between Transcription Factors and Target Genes)"),
                                         withLoader(simpleNetworkOutput("gtex_grn_1"),type="image",loader = "black_loader.jpg"),
                                         h6("Gene Regulatory Network for GTEx data (Interaction between Target Genes and Tissue Signatures)"),
                                         withLoader(simpleNetworkOutput("gtex_grn"),type="image",loader = "black_loader.jpg"),
                                         br(),


                                         actionButton("ex_grn","Explanation", icon = icon("book-open")),
                                         withLoader(verbatimTextOutput("ex_gtexgrn"),type="image",loader = "black_loader.jpg"),

                                         br(), h6("Gene Regulatory Table (GTEx)"),
                                         withLoader(uiOutput("gtex_grn_table"),type="image",loader = "black_loader.jpg"),
                                         br(),br(),br(),

                                         actionButton("ex_grn","Explanation", icon = icon("book-open")),downloadLink('download_gtex_gt', 'Download Table', class = "butt"),
                                         withLoader(verbatimTextOutput("ex_gtexgrn_table"),type="image",loader = "black_loader.jpg"),
